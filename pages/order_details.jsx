                    ...
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                <a href="#" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Transactions</a>
                            ...
                            <div class="card-body">
                                <div id="invoice" class="p-h-30">
                                    ...
                                    <div class="row m-t-20 lh-2">
                                        <div class="col-sm-9">
                                            <h3 class="p-l-10 m-t-10">Order By:</h3>
                                            <address class="p-l-10 m-t-10">
                                                <span class="font-weight-semibold text-dark">Genting Hotel.</span><br/>
                                                <span>(+237) 584 584 555 </span><br/>
                                                <span>Doula 7, Litoral. </span><br/>
                                                <span>Ancient Route Bonaberi</span>
                                            </address>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="m-t-80">
                                                <div class="text-dark text-uppercase d-inline-block">
                                                    <span class="font-weight-semibold text-dark">Order No :</span></div>
                                                <div class="float-right">#1668</div>
                                            </div>
                                            <div class="text-dark text-uppercase d-inline-block">
                                                <span class="font-weight-semibold text-dark">Date :</span>
                                            </div>
                                            <div class="float-right">25 Oct 2020</div>
                                        </div>
                                    </div>
                                    <div class="m-t-20">
