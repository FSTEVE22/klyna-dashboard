                ...
                <div class="main-content">
                    <div class="page-header no-gutters has-tab">
                        ...
                        <ul class="nav nav-tabs nav-justified" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab-network">Social profiles</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image  m-h-10 m-r-15" style={{height: 80+'px', width: 80+'px'}}>
                                        ...
                                        <form>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="email" class="form-control" id="email" placeholder="email" value="mary@njoku.com"/>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                ...
                                                <div class="timepicker-input col-md-4">
                                                    <label class="font-weight-semibold" for="email">Date of Birth:</label>
                                                ...
                                                <div class=" col-md-4">
                                                    ...
                                                    {/* <!-- <select id="selectize-dropdown" class="selectize-dropdown"> --> */}
